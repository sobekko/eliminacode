...
const kioskBottoneDescSize = document.getElementById("kiosk-bottone-desc-size");
...
async function caricaConfig() {
  ...
  kioskBottoneDescSize.value = kiosk.dimensioni.descrizione_servizio || "0.85em";
...
form.addEventListener("submit", async (event) => {
  ...
  const kiosk = {
    ...
    dimensioni: {
      ...
      descrizione_servizio: kioskBottoneDescSize.value.trim() || "0.85em",
    },
    stampa: {
